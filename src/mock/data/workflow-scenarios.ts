...
export const imagingWorkflowsSeed: Workflow[] = [
  ...
  scenario({
    ...
    description:
      "THE MACHINE این گردش‌کار را از ۳۷ درخواست تکراری در گفتگو شناسایی و ساخت.",
    category: "ai",
    source: "ai",
    createdFrom: "الگوی تکراری در گفتگو — ۳۷ بار در ۱۰ روز",
    whyAICreated:
      "مدیر مرکز به‌طور مکرر در گفتگو با THE MACHINE پرسید: «کدام گزارش‌ها آماده‌اند؟»، «کدام بیماران منتظرند؟»، «امروز درآمد چقدر بوده؟» و «کدام پزشک تأخیر دارد؟» THE MACHINE این ۴ سوال را به یک فرآیند واحد تبدیل کرد.",
    conversationOrigin: {
      ...
      conversationExcerpt:
        "شما این ۴ سوال را ۳۷ بار در ۱۰ روز گذشته پرسیده‌اید. آیا می‌خواهید THE MACHINE این فرآیند را خودکار کند؟",
    },
    executiveSummary:
      "ویژگی امضای THE MACHINE: یادگیری از گفتگو، شناسایی الگو، پیشنهاد خودکارسازی و ساخت داشبورد. این گردش‌کار هر صبح خلاصه عملیاتی تولید می‌کند.",
    automationScore: 98,
