    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        <button
          type="button"
          onClick={onMenuOpen}
          className="flex h-9 w-9 items-center justify-center rounded-[var(--radius-lg)] text-text-secondary transition-colors hover:bg-bg-subtle/80 md:hidden"
        ...
        {title && (
          <>
            ...
            <span className="hidden text-[var(--text-sm)] text-text-tertiary truncate sm:inline">
              {title}
            </span>
          </>
        )}
